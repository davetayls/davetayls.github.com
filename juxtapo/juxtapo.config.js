...
juxtapo.initConfig(function(){
	...
	juxtapo.addTemplate('/', 'home.png', {style: {},data: {}});	
	juxtapo.addTemplate('/', 'home-grid.png', {style: {},data: {}});	
	juxtapo.addTemplate('/', 'home-detail-grid.png', {style: {},data: {}});	
	juxtapo.addTemplate('/', 'post.png', {style: {},data: {}});	
	juxtapo.addTemplate('/', 'post-grid.png', {style: {},data: {}});	
});
